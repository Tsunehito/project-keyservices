                ...
                <div className="container forms">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div className="card">
                                <div className="card-header bg-primary text-white"><i className="fa fa-user"></i> Mes
                                    informations
                                </div>
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div className="card mb-3">
                                <div className="card-header bg-primary text-white"><i
                                    className="fa fa-pencil"></i> Modifier mon mot de passe
                                </div>
                                <div className="card-body">
                                  ...
                                  {errors.password3}  
                                        ...
                                        <div className="mx-auto">
                                            <button type="submit" className="btn btn-primary text-right">changer
                                            </button>
                                        </div>
                                    </form>
                                </div>
