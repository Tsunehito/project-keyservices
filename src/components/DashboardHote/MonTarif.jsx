                ...
                <div class="pricing card-deck flex-column flex-md-row mb-3">
                    <div class="card card-pricing text-center px-3 mb-4">
                        <span class="h6 w-60 mx-auto px-4 py-1 rounded-bottom  text-white shadow-sm"
                              style={{backgroundColor: '#00cccb'}}>Pack check-in check-out</span>
                        <div class="bg-transparent card-header pt-4 border-0">
                            <h1 class="h1 font-weight-normal text-primary text-center mb-0"
                                data-pricing-value="15">18<span class="price">%</span><span class="h6 text-muted ml-2">+ TVA</span>
                            </h1>
                        </div>
                    ...
                    <div class="card card-pricing popular shadow text-center px-3 mb-4">
                        <span class="h6 w-60 mx-auto px-4 py-1 rounded-bottom  text-white shadow-sm"
                              style={{backgroundColor: '#ed7e24'}}>Pack All inclusive</span>
                        <div class="bg-transparent card-header pt-4 border-0">
                            <h1 class="h1 font-weight-normal text-primary text-center mb-0"
                                data-pricing-value="30">25<span class="price">%</span><span class="h6 text-muted ml-2">+ TVA</span>
                            </h1>
                        </div>
                        <div class="card-body pt-0">
                            <ul class="list-unstyled mb-4">
