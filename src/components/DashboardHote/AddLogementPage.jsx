                    ...
                    <div className="col-md-6 mt-5 mx-auto">
                        <form noValidate onSubmit={this.onSubmit}>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="address" placeholder="num, rue, avenue..."
                            ...
                            <div className="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nb_lits" id="nb_lits" placeholder="nombre de lits"
                                           className={classnames("form-control", {
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nb_sdb" id="nb_sdb" placeholder="salles de bain"
                                           className={classnames("form-control", {
                            ...
                            <div className="form-group">
                                ...
                                <textarea className={classnames("form-control", {
                                    invalid: errors.description
                                          ...
                                          onChange={this.onChange} name="description" id="description" rows="6"
                                          required></textarea>
                            </div>
