                ...
                <div className="container forms">
                    <div className='row'>
                        ...
                        <p className="text-center col-lg-12 col-md-12 col-xs-12">
                            {errors.message ? <span className="alert alert-danger alert-dismissible fade show"
                                                    style={{width: 'auto'}}>{errors.message}
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div className="card bg-light mb-3">
                                <div className="card-header bg-success text-white text-uppercase"><i
                                    className="fa fa-home"></i> Détails du logement
                                </div>
                            ...
                            <div className="card mb-3">
                                <div className="card-header bg-primary text-white"><i
                                    className="fa fa-pencil"></i> Modifier le tarif
                                </div>
                                <div className="card-body">
                                    <form noValidate>
                              ...
                              {errors.bureau}  
                                        ...
                                        <div className="form-group">
                                            ...
                                            <select className={classnames("form-control", {
                                                ...
                                                <option value=""></option>
                                                <option value="renseignement">Je suis intéressé par les service de Key
                                                    Service
                                                </option>
                                                <option value="voyageur">Je séjourne dans un logement de Key Service
                                                </option>
                              ...
                              {errors.mailSubject}  
                                        ...
                                        <div className="mx-auto">
                                            <button type="submit" className="btn btn-primary text-right">Sauvegarder
                                            </button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div className="card">
                                <div className="card-header bg-primary text-white"><i
                                    className="fa fa-pencil"></i> Mettre à jour les informations de mon logement
                                </div>
                                <div className="card-body">
                              ...
                              <span aria-hidden="true">&times;</span>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" name="complement" value={this.state.complement}
                                                   onChange={this.onChange} className="form-control" id="complement"
                                        ...
                                        <div className="row">
                                            <div className="form-group col-md-6">
                                                ...
                                                <input type="text" name="nb_lits" id="nb_lits"
                                                       placeholder="nombre de lits" className="form-control"
                                            ...
                                            <div className="form-group col-md-6">
                                                ...
                                                <input type="text" name="nb_sdb" id="nb_sdb"
                                                       placeholder="salles de bain" className="form-control"
                                        ...
                                        <div className="form-group">
                                            ...
                                            <textarea className="form-control"
                                                      ...
                                                      onChange={this.onChange} name="description" id="description"
