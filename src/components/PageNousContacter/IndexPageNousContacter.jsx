            ...
            <div className="container forms">
                <div className='row'>
                    <p className="text-center col-lg-12 col-md-12 col-xs-12">
                        {mail ?
                            <span className="alert alert-success alert-dismissible fade show" style={{width: 'auto'}}>message envoyé!
                    ...
                    <div className="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                        <div className="card">
                            <div className="card-header bg-primary text-white"><i
                                className="fa fa-envelope"></i> Contact us.
                            </div>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" name="firstname" className={classnames("form-control", {
                                            invalid: errors.firstname
                                               ...
                                               onChange={this.onChange} id="firstname" aria-describedby="emailHelp"
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="email" name="email" className={classnames("form-control", {
                                            invalid: errors.email
                                               ...
                                               onChange={this.onChange} id="email" aria-describedby="emailHelp"
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" name="telephone" className={classnames("form-control", {
                                            invalid: errors.telephone
                                               ...
                                               onChange={this.onChange} id="telephone" aria-describedby="emailHelp"
                                    ...
                                    <div className="form-group">
                                        ...
                                        <textarea className={classnames("form-control", {
                                            invalid: errors.mailContent
                                                  ...
                                                  onChange={this.onChange} name="mailContent" id="mailContent" rows="6"
                                                  required></textarea>
                                        <span className="red-text" style={{color: 'red'}}>
                          		{errors.mailContent}  
                      		</span>
