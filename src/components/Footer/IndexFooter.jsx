            ...
            <div className="container-fluid foot1  ">
                <div className="row niveau1 d-flex justify-content-center">
                    <div className="col-md-12 text-center">
                        <img className="hidden-xs img-block" src="/assets/keyLogo2.png" alt=""/>
                    </div>
                </div>
                ...
                <div className="row  foo justify-content-center">
                    ...
                    <div className="col-md-4 colonne  text-center">
                        ...
                        <ul className="social-network social-circle">
                            <li><a target="_blank" href="/#" className="icoRss" title="Youtube"><i
                                className="fa fa-rss ico"></i> </a></li>
                            <li><a target="_blank" href="/#" className="icoFacebook" title="Facebook"><i
                                className="fa fa-facebook ico"></i> </a></li>
                            <li><a target="_blank" href="/#" className="icoTwitter" title="Twitter"><i
                                className="fa fa-twitter ico"></i> </a></li>
                            <li><a target="_blank" href="/#" className="icoGoogle" title="Google +"><i
                                className="fa fa-google-plus ico"></i> </a></li>
                            <li><a target="_blank" href="/#" className="icoLinkedin" title="Linkedin"><i
                                className="fa fa-linkedin ico"></i> </a></li>
                        </ul>
                    </div>
                    <div className="col-md-4 colonne md-0">
