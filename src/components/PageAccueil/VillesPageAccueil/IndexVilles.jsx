                                ...
                                <div className="carousel-inner no-padding">
                                    <div className="carousel-item active">
                                        <div className="col-xs-3 col-sm-3 col-md-3">
                                            <img src="/assets/bordeaux.jpg" alt=""/>
                                        </div>
                                        <div className="col-xs-3 col-sm-3 col-md-3">
                                            <img src="/assets/paris.jpg" alt=""/>
                                        </div>
                                        <div className="col-xs-3 col-sm-3 col-md-3">
                                            <img src="/assets/lyon.jpg" alt=""/>
                                        </div>
                                        <div className="col-xs-3 col-sm-3 col-md-3">
                                            <img src="/assets/marseille.jpg" alt=""/>
                                        </div>
                                    </div>
                                    <div className="carousel-item">
                                        <div className="col-xs-3 col-sm-3 col-md-3">
                                            <img src="/assets/nante1.jpg" alt=""/>
                                        </div>
                                        <div className="col-xs-3 col-sm-3 col-md-3">
                                            <img src="/assets/toulouse.jpg" alt=""/>
                                        </div>
                                        <div className="col-xs-3 col-sm-3 col-md-3">
                                            <img src="/assets/monaco2.jpg" alt=""/>
                                        </div>
                                        <div className="col-xs-3 col-sm-3 col-md-3">
                                            <img src="/assets/lesalpes.jpg" alt=""/>
                                        </div>
                                    </div>
