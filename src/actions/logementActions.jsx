...
import {
    GET_LOGEMENTS, GET_ONE_LOGEMENT, ADD_LOGEMENT,
    UPDATE_LOGEMENT, LOGEMENTS_LOADING, GET_ERRORS
} from './types.jsx';
...
export const getLogementById = logementId => dispatch => {
    ...
    axios
        .get(`/api/logements/${logementId}`, config)
        .then(res => {
...
export const updateLogement = (logementId, data, history) => dispatch => {
    ...
    axios.put(`/api/logements/${logementId}`, data, config)
        .then(res => {
