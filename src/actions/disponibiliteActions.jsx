...
import {GET_AVAILABILITIES, ADD_AVAILABILITY, AVAILABILITY_FETCHED, AVAILABILITY_UPDATED, GET_ERRORS } from './types';
...
axios
  .get(`/api/disponibilites/${disponibiliteId}`, config)
  .then(res=> 
    dispatch({
...
axios
  .put(`/api/disponibilites/${disponibiliteId}`, dispoData, config)
  .then(res=> {
    dispatch({
...
axios
  .delete(`/api/disponibilites/${disponibiliteId}`, config)
  .then(res=> {
